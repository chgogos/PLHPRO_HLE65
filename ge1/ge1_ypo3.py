...
while (char_position==-1 or char_position>len(astring)): # αμυντικός προγραμματισμός
    char_position=int(input("Parakalw eisagete thn thesi tou xaraktira pros afairesi: ")) # είσοδος
    print(astring[:char_position-1]+astring[char_position:]) # εκτύπωση συμβολοσειράς εξαιρουμένου του χαρακτήρα στην θέση char_position
